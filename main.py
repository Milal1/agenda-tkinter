...
# Todo Comobox categoria vai ser adicionado aqui
...
btn_adicionar = Button(janela, text="Adicionar", fg="navy",
                       bg="white", font="Tahoma 12 bold", width=10, height=1,
                       command=adicionarContato)
btn_adicionar.grid(row=3, column=0)

btn_editarContato = Button(janela, text="Editar", fg="navy",
                       bg="white", font="Tahoma 12 bold", width=10, height=1,
                       command=editarContato)
btn_editarContato.grid(row=3, column=1)

btn_excluirContato = Button(janela, text="Excluir", fg="navy",
                       bg="white", font="Tahoma 12 bold", width=10, height=1,
                       command=excluirContato)
btn_excluirContato.grid(row=3, column=2)
...
# Criando a ação/bind para quando o usuário clicar no contato na tabela
